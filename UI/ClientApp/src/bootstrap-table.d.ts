...
interface PaginationProps {
  ...
  */
  ...
  handleSizePerPage?: (
    event: { page: number; onSizePerPageChange: () => void },
...
declare module "react-bootstrap-table-next" {
  ...
  > extends React.Component<BootstrapTableProps<FieldIds>, TODO> {}
  export interface BootstrapTableProps<fieldIds extends string = string>
...
declare module "react-bootstrap-table2-filter" {
  export default function filterFactory<Type extends TODO>(
